...
{
	int TAMANHOMATRIZ = atoi(argv[1]), height = atoi(argv[2]);;
	int contador1, contador2, contador3, i, j;
	__m128 capsula;
    __m128 vetor1;
    __m128 vetor2;
	...
	for(contador1 = 0; contador1 < TAMANHOMATRIZ; contador1++)
	{
		for(contador2 = 0; contador2 < TAMANHOMATRIZ; contador2++)
		{
			for(i=0;i<TAMANHOMATRIZ;i++)
				vetorapoiador1[i] = matriz1[contador1][i];
			for(i=0;i<TAMANHOMATRIZ;i++)
				vetorapoiador2[i] = matriz1transposta[contador2][i];
